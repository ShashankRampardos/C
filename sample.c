...
main()
{
   int a,b;//to enter two angles
   char sel;//to enter y or n.
start://goto tag
   printf("\nEnter two angles:");
   scanf("%d%d",&a,&b);
...
middle://goto tag
   ...
   scanf("%c",&sel);//ISSUE 1:scanf() not run in first time and control branch to ELSE without taking input to "sel" variable, why? Please run the program to understand what I'm saying.
